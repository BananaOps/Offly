...
type UpdateUserRequest struct {
	...
	Email   string                 `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"`
	Country string                 `protobuf:"bytes,4,opt,name=country,proto3" json:"country,omitempty"`
	// Conservé pour les clients existants : historiquement, title portait le profil.
	Title string `protobuf:"bytes,5,opt,name=title,proto3" json:"title,omitempty"`
	// Champ explicite, aligné sur User.job_profile. Prioritaire sur title.
	JobProfile    string `protobuf:"bytes,6,opt,name=job_profile,json=jobProfile,proto3" json:"job_profile,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UpdateUserRequest) GetJobProfile() string {
	if x != nil {
		return x.JobProfile
	}
	return ""
...
const file_absence_v1_absence_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x10.absence.v1.UserR\x04user\"\x9e\x01\n" +
